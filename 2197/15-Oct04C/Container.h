...
namespace sdds {
   ...
   public:
      ...
      friend Container operator+(const Container& LeftOperand, const Container& RightOperand);
   };

   Container operator+(const Container& LeftOperand, const Container& RightOperand);
