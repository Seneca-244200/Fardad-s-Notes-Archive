...
namespace seneca {
   ...
   // cool thing to design
   // bool Utils::getDynCstr( char*& str, std::istream& istr, const char* delimiter );

   bool Utils::getDynCstr( char*& str, std::istream & istr, char delimiter ) {
         delete[] str;
      str = nullptr;
