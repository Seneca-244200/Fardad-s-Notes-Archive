...
/// <summary>
/// prints an array in comman seperated format
/// </summary>
/// <typeparam name="T">Array type must be insertabe into ostream</typeparam>
/// <param name="array"></param>
/// <param name="size"></param>
/// <param name="ostr"></param>
/// <returns></returns>
template <typename T>
std::ostream& prnArray( const T* array, int size , std::ostream& ostr = std::cout) {
