...
## SGSM
### Feedback 
Header file compilation safeguards are missing
### Problematic code sample
```C++
#pragma once  // with or without this
namespace seneca
{
...
### The Fix
```C++
#ifndef SENECA_MODULENAME_H
#define SENECA_MODULENAME_H
namespace seneca
{
...
[Add citation as stated here](https://github.com/Seneca-244200/OOP-Workshops?tab=readme-ov-file#citation-policy)
