...
int main() {
   ...
   k = add<int>(m, i);// explicit function generation request for int regardless of function call signature

   o = add<double>(j, i); // explicit function generation request for double regardless of function call signature
