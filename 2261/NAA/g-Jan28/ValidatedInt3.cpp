...
namespace seneca {
   ...
   ValidatedInt::ValidatedInt(){
      initialize(0, -100, 100);
   }

   ValidatedInt::ValidatedInt(int minv, int maxv){
      initialize(0, minv, maxv);
   }

   ValidatedInt::ValidatedInt(int val, int minv, int maxv){
      initialize(val, minv, maxv);
   }
