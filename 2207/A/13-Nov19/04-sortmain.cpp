...
template <class T>
void display(const char* title, T d[], int size) {
   cout << title << endl;
...
int main() {
   Car C[5] = { Car("DEFGHI", "Tesla Model S"), Car("ABCDEF", "BMW 320"), Car("CDEFGH", "Ford Festiva"), Car("BCDEFG", "Ford Festiva"), Car("EFGHIJ", "Nissan Maxima") };
   Student S[6] = { Student(23456, "Lisa Simpson"), Student(12345, "Bart Simpson"), Student(45678, "Ralph Wiggum"), Student(56789, "Milhouse Van Houten"), Student(67890, "Todd Flanders"), Student(34567, "Nelson Muntz") };
   Employee E[6] = { Employee(213456, "Carl Carlson", 62344.56), Employee(122345, "Mindy Simmons", 65432.44), Employee(435678, "Lenny Leonard", 43213.22), Employee(546789, "Waylon Smithers", 654321.55), Employee(657890, "Frank Grimes", 34567.88), Employee(364567, "Homer Simpson", 55432.11) };
   ...
   sort(vals, 10);
   display("Cars", C, 5);
   display("Students", S, 6);
   display("Employees", E, 6);
   display("integers", vals, 10);
   return 0;
}