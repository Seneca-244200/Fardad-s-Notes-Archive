...
int main() {
   ...
   /* 
   how to find the operator's action:
   * check the operator to see if it can handle the operands with C++ definintion
   * C = E.operator-(D) // if this exist
   * C = operator-(E, D); // if this exists
   */
