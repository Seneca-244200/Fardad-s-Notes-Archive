...
namespace sdds {
   ...
   Container::Container() :m_amount{}, m_volume{}{
      //init();
   }
   Container::Container(const char* content) :m_amount{ 220 }, m_volume(220) {
      //init();
      set(content, 220, 220);
   }

   Container::Container(const char* content, 
      int amount, int volume) :m_amount{ amount }, m_volume{ volume } {
      //init();
