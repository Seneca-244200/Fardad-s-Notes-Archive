...
namespace sdds {
   ...
   //}
   // builds the base usign copy constructor of base and it will copy only the "Name"
   // part of Fullname,
   ...
   // builds the base using default constructor and then overwrites it with operator=
