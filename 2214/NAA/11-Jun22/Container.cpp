...
namespace sdds {
   ...
   //   bool res = false;
   //   if (C && *this) {
   //      double dif = m_value - C.m_value;
   //      res = strcmp(m_content, C.m_content) == 0 &&
   //         (dif > -0.001 && dif < 0.001);
   //   }
   //   return res;
   //}
   ...
   // this needs to be a friend because it is accessing the private properties
   // of the container
   //bool operator==(const Container& left, const Container& right) {
   //      bool res = false;
   //      if (left && right) {
   //         double dif = left.m_value - right.m_value;
   //         res = strcmp(left.m_content, right.m_content) == 0 &&
   //            (dif > -0.001 && dif < 0.001);
   //      }
   //      return res;
   //}
